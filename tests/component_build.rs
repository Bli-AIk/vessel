...
#[test]
fn refreshes_timestamp_without_reformatting_semantically_equal_ron() {
    let output_dir = temp_output_dir("vessel_component_semantic_preserve");
...
"#
    ...
    .expect("semantically equal output should refresh timestamp");
